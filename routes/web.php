...
Route::get('/', function () {
    return Inertia::render('Pages/Common/Welcome');
});
...
Route::prefix('admin')->middleware('web')->group(function() {
    ...
    Route::get('auth/lock', 'Auth\\LoockScreenController@lock')->name('login.locked');
    Route::post('auth/unlock', 'Auth\\LoockScreenController@unlock')->name('login.unlock');
});
